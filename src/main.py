from prompt_load import prompt_load
...
system_prompt = prompt_load(system_prompt_folder, summarize_reviews_file)
user_prompt = prompt_load(user_prompt_folder, user_review_file).format(review=review)
...
def main():
    ...
    response = ask_llm(system=system_prompt, user=user_prompt)
    print(response)
